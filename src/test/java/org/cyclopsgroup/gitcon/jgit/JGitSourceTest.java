...
public class JGitSourceTest
{
    ...
    {
        workingDirectory =
            new File( SystemUtils.JAVA_IO_TMPDIR + SystemUtils.FILE_SEPARATOR
    ...
    @Test
    public void testWithSpecifiedSshKey()
        throws GitAPIException, IOException
    {
        JGitSource source =
            new JGitSource( "git@bitbucket.org:jiaqi/gitcon-demo-config.git" );
    ...
    @Test
    public void testWithBuildInSshKey()
        throws GitAPIException, IOException
    {
        JGitSource source =
            new JGitSource( "git@bitbucket.org:jiaqi/gitcon-demo-config.git" );
